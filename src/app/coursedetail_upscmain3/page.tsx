...
import inner from "../images/upscmains/course3.jpg";
  ...
  return (
    <div className="inner_page">
      <div className="solid_bg">
        <h3>UPSC Mains Daily Answer Writing Program Paper 1</h3>
      </div>
        ...
        <div className="row mb-4">
              ...
              <div className="col-lg-8">
                <div className="price_Details">
                  ...
                  <a href="https://mgxpi.courses.store/355859?utm_source%3Dother%26utm_medium%3Dtutor-course-referral%26utm_campaign%3Dcourse-overview-webapp" target="_blank">
