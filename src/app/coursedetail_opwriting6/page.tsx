...
import inner from "../images/mentorship_answer_writing/course6.jpg";
  ...
  return (
    <div className="inner_page">
      <div className="solid_bg">
        <h3>SOCIOLOGY MENTORSHIP & ANSWER WRITING PROGRAM</h3>
      </div>
        ...
        <div className="row mb-4">
              ...
              <div className="col-lg-8">
                <div className="price_Details">
                  <h3></h3>
                  <h4><strong>PRICE</strong> - ₹ 14,999/-</h4>
                  <br></br>
                  <h4><strong>VALIDITY </strong> - 1 YEARS</h4>
                  <a href="https://mgxpi.courses.store/394640?utm_source%3Dother%26utm_medium%3Dtutor-course-referral%26utm_campaign%3Dcourse-overview-webapp" target="_blank">
          ...
          <br></br>
            ...
            <p>	EXAM STRATEGY & TIME MANAGEMENT.	</p>
            <p>	DAILY ANSWER WRITING – 2 QUESTIONS DAILY	</p>
            <p>	REVISION TEST	</p>
