      ...
      <section className="inner_pages_Section">
        ...
        <div className="row mb-4">
          ...
          <div className="inner_content">
            ...
            <p>	Covers the subject comprehensively.	</p>
            ...
            <p>	3.     Interactive Classroom Experience: Benefit from an environment that challenges and stimulates your intellectual curiosity.	</p>
